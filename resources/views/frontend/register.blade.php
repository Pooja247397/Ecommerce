        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              ...
              <!--  <p class="mb-5 pb-lg-2" style="color: #393f81;">Home <a href="{{ url('loginsignup') }}"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="{{url('submit')}}" method = "POST">
                  ...
                  <h6 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign-Up</h6>
                  <div class="form-outline mb-4">
                    <input type="name"  class="form-control form-control-lg" name="name" placeholder="Enter your name"/>
                 ...
                 <button type="submit" class="btn btn-primary btn-block">Submit</button>
                    ...
                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have an account? <a href="{{ url('loginsignup') }}"
                      style="color: #393f81;">LOGIN</a></p>
